...
function BookCard() {
  return (
    <div className="bg-Cards rounded overflow-hidden shadow-md w-full md:w-72 p-3">
      ...
      <div className="flex justify-between items-center px-1 pt-2">
        ...
        <VscHeart
          size={25}
          className="transform transition ease-in duration-100 hover:-translate-y-0.5"
        />
      </div>
      ...
      <p className="font-bold pl-1">9.99$</p>
